...
export class BSpline implements Cell {
	...
	mutate(): void {
		this.a = clamp(this.a + randomGaussian(0, 0.1), -3, 3)
		this.b = clamp(this.b + randomGaussian(0, 0.1), -3, 3)
		this.c = clamp(this.c + randomGaussian(0, 0.1), -3, 3)
		this.d = clamp(this.d + randomGaussian(0, 0.1), -3, 3)
	}
}
